...
#    Updated: 2016/09/16 15:15:38 by tgauvrit         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME1_DIR =		server_space

NAME1 =			$(NAME1_DIR)/serveur
NAME2 =			client
...
fclean: clean
	...
	/usr/bin/find . -name "$(NAME1_DIR)" -maxdepth 1 -type d -empty -delete
